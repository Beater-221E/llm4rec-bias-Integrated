...
from llm4rec_bias_Integrated.evaluation.ranking import CandidateLogProbEvaluator
from llm4rec_bias_Integrated.models.loader import load_model_bundle
from llm4rec_bias_Integrated.trainers.distributed import resolve_distributed_plan
...
class GRPO4RecWorkflow(RecommendationWorkflow):
    ...
    def build_probes(self, context: ExperimentContext) -> list[Any]:
        from llm4rec_bias_Integrated.probes.registry import build_probes_from_config
