...
from llm4rec.core.context import build_run_dir, create_context
...
from llm4rec.components.evaluation._impl.hacking import analyze_reward_hacking, write_hacking_report
...
from llm4rec.workflows.registry import build_workflow
...
def run_train(overrides: list[str]) -> int:
    ...
    if is_sid:
        ...
        from llm4rec.workflows.minionerec.semantic_ids.build import (
            build_semantic_ids,
            build_sid_dataset,
            sid_dir,
        )
