...
def cmd_train_retriever(args: argparse.Namespace) -> int:
    from llm4rec.workflows.mllm4rec._stack.retriever.train import RetrieverConfig, train_retriever
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="python -m llm4rec.workflows.mllm4rec._stack.cli")
