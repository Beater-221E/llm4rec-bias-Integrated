...
step validate python -m llm4rec.cli.main validate experiment=smoke_grpo
step prepare  python -m llm4rec.cli.main prepare experiment=smoke_test dataset=movielens_100k
step train    python -m llm4rec.cli.main train experiment=smoke_grpo
